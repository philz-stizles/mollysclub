...
//   private PatientCaseService appointmentService;
  
//   @Autowired
//   public PatientTestController(PatientCaseService appointmentService) {
...
//     return new ResponseEntity<List<PatientCaseDto>>(appointmentService.getAll(), HttpStatus.OK);
//   }
