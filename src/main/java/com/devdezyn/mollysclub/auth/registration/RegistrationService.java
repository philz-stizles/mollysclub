...
// import com.devdezyn.mollysclub.auth.AppUserRole;
...
// import com.devdezyn.mollysclub.user.UserServiceImpl;
...
//   private final RoleServiceImpl appUserService;
...
//     String token =  appUserService.registerUser(new User(request.getFirstName(), request.getLastName(), request.getEmail(),
